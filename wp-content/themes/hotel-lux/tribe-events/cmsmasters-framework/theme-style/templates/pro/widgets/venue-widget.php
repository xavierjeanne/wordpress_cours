...
<div class="tribe-venue-widget-wrapper">
	...
	<?php if ( 0 === $events->post_count ): ?>
		<?php printf( esc_html__( 'No upcoming %s.', 'hotel-lux' ),  strtolower( $events_label_plural ) ); ?>
	<?php else: ?>
	...
	<p class="tribe-events-widget-link">
		<a href="<?php echo esc_url( tribe_get_venue_link( $venue_ID, false ) ); ?>"><?php printf( esc_html__( 'View all %s at this %s', 'hotel-lux' ), $events_label_plural, tribe_get_venue_label_singular() ); ?></a>
	</p>
</div>
