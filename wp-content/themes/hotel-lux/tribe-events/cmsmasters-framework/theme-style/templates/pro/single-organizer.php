	...
	<div class="cmsmasters_events_organizer_header clearfix">
		...
		<div class="cmsmasters_events_organizer_header_right clearfix">
			<div class="tribe-events-back">
				<a class="cmsmasters_theme_icon_date" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'Back to %s', 'hotel-lux' ), tribe_get_event_label_plural() ); ?></a>
			</div>
		</div>
	</div>
