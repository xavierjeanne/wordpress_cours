...
if ( isset( $posts ) && $posts ) : ?>
	...
	<p class="tribe-events-widget-link">
		<a href="<?php echo esc_url( $link_to_all ) ?>" rel="bookmark">
			<?php esc_html_e( 'View More&hellip;', 'hotel-lux' ) ?>
		</a>
	</p>
...
?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'hotel-lux' ), strtolower( tribe_get_event_label_plural() ) ); ?></p>
<?php
endif;
