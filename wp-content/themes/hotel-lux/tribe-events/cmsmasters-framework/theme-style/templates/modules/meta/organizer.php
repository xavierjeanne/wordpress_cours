	...
	<div class="cmsmasters_event_meta_info">
		...
		foreach ( $organizer_ids as $organizer ) {
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e('Organizer Name:', 'hotel-lux'); ?></span>
		...
		if ( ! $multiple ) { // only show organizer details if there is one
			...
			if ( ! empty( $email ) ) {
				?>
				<div class="cmsmasters_event_meta_info_item">
					<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e( 'Email:', 'hotel-lux' ) ?></span>
