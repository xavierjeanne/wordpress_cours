...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<h5 class="tribe-events-single-section-title"><?php esc_html_e( 'Details', 'hotel-lux' ) ?></h5>
	<div class="cmsmasters_event_meta_info">
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e( 'Start:', 'hotel-lux' ) ?></span>
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e( 'End:', 'hotel-lux' ) ?></span>
				<span class="cmsmasters_event_meta_info_item_descr">
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e( 'Date:', 'hotel-lux' ) ?></span>
				<span class="cmsmasters_event_meta_info_item_descr">
					<abbr class="tribe-events-abbr updated published dtstart" title="<?php echo esc_attr( $start_ts ) ?>"> <?php echo esc_html( $start_date ) ?> </abbr>
				</span>
			</div>
		...
		// Single day events
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e( 'Time:', 'hotel-lux' ) ?></span>
				<span class="cmsmasters_event_meta_info_item_descr">
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php esc_html_e( 'Cost:', 'hotel-lux' ) ?></span>
		...
		if (get_the_terms(get_the_id(), 'tribe_events_cat')) {
			...
			echo '<div class="cmsmasters_event_meta_info_item">' . 
				'<span class="cmsmasters_event_meta_info_item_title">' . 
					sprintf(_n('%s Category', '%s Categories', $cmsmasters_tribe_events_cat_count, 'hotel-lux'), tribe_get_event_label_singular()) . 
				'</span>' . 
				'<span class="cmsmasters_event_meta_info_item_descr tribe-events-event-categories">' . 
					hotel_lux_get_the_category_list(get_the_id(), 'tribe_events_cat', ', ') . 
				'</span>' . 
			'</div>';
		}
		
		
		$cmsmasters_event_tags = tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'hotel-lux' ), tribe_get_event_label_singular() ), ', ', false );
		
		if ($cmsmasters_event_tags) {
			echo '<div class="cmsmasters_event_meta_info_item cmsmasters_event_tags">' . 
				'<dl>' . tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'hotel-lux' ), tribe_get_event_label_singular() ), ', ', false ) . '</dl>' . 
			'</div>';
		}
		?>
