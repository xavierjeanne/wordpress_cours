...
<div id="tribe-events-content" class="tribe-events-single vevent hentry">
		...
		<div class="cmsmasters_single_event_header clearfix">
			...
			<div class="cmsmasters_single_event_header_right clearfix">
				<div class="tribe-events-back">
					<a class="cmsmasters_theme_icon_date" href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( esc_html__( 'All %s', 'hotel-lux' ), $events_label_plural ); ?></a>
				</div>
	...
	if ($published_events > 1) {
		echo '<aside id="tribe-events-sub-nav" class="post_nav cmsmasters_single_tribe_nav">';
				...
				tribe_the_prev_event_link('<span class="post_nav_sub">' . esc_html__('Previous', 'hotel-lux') . '<span class="post_nav_type"> ' . esc_html__('Event', 'hotel-lux') . ' </span>' . esc_html__('Link', 'hotel-lux') . '</span>%title%<span class="cmsmasters_prev_arrow"><span>');
			
			
			
			
				tribe_the_next_event_link('<span class="post_nav_sub">' . esc_html__('Next', 'hotel-lux') . '<span class="post_nav_type"> ' . esc_html__('Event', 'hotel-lux') . ' </span>' . esc_html__('Link', 'hotel-lux') . '</span>%title%<span class="cmsmasters_next_arrow"><span>');
