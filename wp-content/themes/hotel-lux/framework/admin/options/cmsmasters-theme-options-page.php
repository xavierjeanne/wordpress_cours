...
if (!function_exists('hotel_lux_get_custom_page_meta_fields')) {
function hotel_lux_get_custom_page_meta_fields() {
	$cmsmasters_option = hotel_lux_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['hotel-lux' . '_layout']) && $cmsmasters_option['hotel-lux' . '_layout'] !== '') ? $cmsmasters_option['hotel-lux' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['hotel-lux' . '_header_overlaps']) && $cmsmasters_option['hotel-lux' . '_header_overlaps'] !== '') ? (($cmsmasters_option['hotel-lux' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'hotel-lux'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'hotel-lux'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'hotel-lux'), 
