...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['hotel-lux' . '_google_web_fonts']) && is_array($cmsmasters_option['hotel-lux' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['hotel-lux' . '_google_web_fonts'];
		...
		$fonts = array( 
			'' => esc_html__('None', 'hotel-lux'), 
			'local' => $local_fonts, 
			'web' => $google_web_fonts 
		);
		
		
		return apply_filters('hotel_lux_google_fonts_list_filter', $fonts);
	}
}
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'hotel-lux'), 
			'lowercase' => esc_html__('lowercase', 'hotel-lux'), 
			'capitalize' => esc_html__('capitalize', 'hotel-lux'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = hotel_lux_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = hotel_lux_all_color_schemes_list();
