...
<?php hotel_lux_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php hotel_lux_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header"<?php 
	if ($cmsmasters_option['hotel-lux' . '_header_styles'] == 'fullwidth') {
...
<div id="middle">
<?php 
hotel_lux_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = hotel_lux_theme_page_layout_scheme();
