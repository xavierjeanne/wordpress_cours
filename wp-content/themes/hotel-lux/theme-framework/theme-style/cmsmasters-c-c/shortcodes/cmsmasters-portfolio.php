...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Rooms', 'hotel-lux');
...
$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'hotel-lux');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'hotel-lux');
...
if ($query->have_posts()) : 
	while ($query->have_posts()) : $query->the_post();
		if ($layout == 'puzzle') {
			$out .= cmsmasters_composer_ob_load_template('theme-framework/theme-style/postType/portfolio/project-puzzle.php', $this->portfolio_atts);
		} else {
			$out .= cmsmasters_composer_ob_load_template('theme-framework/theme-style/postType/portfolio/project-grid.php', $this->portfolio_atts);
		}
	endwhile;
