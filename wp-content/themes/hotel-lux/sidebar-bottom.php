...
if ( 
	...
	$cmsmasters_bottom_sidebar = get_post_meta($cmsmasters_page_id, 'cmsmasters_bottom_sidebar', true) !== '' ? get_post_meta($cmsmasters_page_id, 'cmsmasters_bottom_sidebar', true) : ($cmsmasters_option['hotel-lux' . '_bottom_sidebar'] == 1 ? 'true' : 'false');
	
	$cmsmasters_bottom_sidebar_layout = get_post_meta($cmsmasters_page_id, 'cmsmasters_bottom_sidebar_layout', true) !== '' ? get_post_meta($cmsmasters_page_id, 'cmsmasters_bottom_sidebar_layout', true) : $cmsmasters_option['hotel-lux' . '_bottom_sidebar_layout'];
} else {
	$cmsmasters_bottom_sidebar = $cmsmasters_option['hotel-lux' . '_bottom_sidebar'] == 1 ? 'true' : 'false';
	
	$cmsmasters_bottom_sidebar_layout = $cmsmasters_option['hotel-lux' . '_bottom_sidebar_layout'];
}
...
if ( 
	...
	<!-- Start Bottom -->
	<div id="bottom" class="cmsmasters_color_scheme_<?php echo esc_html($cmsmasters_option['hotel-lux' . '_bottom_scheme']) ?>">
		<div class="bottom_bg">
